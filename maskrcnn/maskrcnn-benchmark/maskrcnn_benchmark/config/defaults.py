...
_C.MODEL.SIDE = True
_C.MODEL.ONLY_SIDE = False
_C.MODEL.RANDOM_SELECT = False
_C.MODEL.PREDICTOR_NUM = 1
_C.MODEL.TEMP = 1
...
_C.MODEL.META_ARCHITECTURE = "Baseline1"
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "/data6/SRIP19_SelfDriving/Outputs/"
